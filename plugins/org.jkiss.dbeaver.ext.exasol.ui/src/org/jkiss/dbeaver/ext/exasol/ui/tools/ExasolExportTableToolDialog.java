...
public class ExasolExportTableToolDialog extends ExasolBaseTableToolDialog {
    ...
    public ExasolExportTableToolDialog(
    ...
    protected void createControls(final Composite parent) {
        ...
        UIUtils.createPushButton(composite,
        ...
        txFileName.addModifyListener(arg0 -> {
        ...
        cbEncoding.select(0);
        encoding = ExasolUIConstants.encodings.getFirst();
        ...
        cbRowSep.select(0);
        rowSep = ExasolUIConstants.rowSeparators.getFirst();
        ...
        //  string sep mode
        cbStringSepMode = UIUtils.createLabelCombo(
            composite,
            ExasolMessages.dialog_table_tools_string_sep_mode,
        ...
        sepMode = ExasolUIConstants.stringSepModes.getFirst();
